...
| Date | Item | Project |
|------|------|---------|
| Apr 21 | Duetto attendee lists arrive → generate reports + emails | [[Guest Personas]] |
| Apr 29 | In-person day with [[Tobias Gunkel]] (pending) | General |
| Apr 30 | Revisit [[Help Centre Bot]] — pushed back, time to re-engage with [[Megan Bryant]] | [[Help Centre Bot]] |
...
### [[Guest Persona CRM Tagging]] — HIGH
...
### [[DBS Guest Personas Print Assets]] — HIGH / URGENT (May 5 deadline)
- [ ] Await copy from [[Meg]]
- [ ] Figure out design approach for landscape booklet format
- [ ] Run all guest persona reports via client route on Salesforce
- [ ] Edit reports to match new 8-page layout (3 featured personas)
- [ ] Final review and send to print before May 5
...
### [[AI & Automation Session]] — Recurring (Thursdays 10am)
- [ ] Set up prep agent to provide weekly research/topics
- [ ] Gather topic ideas for upcoming sessions

### General
- [ ] UI/UX design advice for website pages
- [ ] Review [[Larry Hogan]]'s new "AI at Triptease" Notion space and AI Asset Library
- [ ] Follow up with [[Simon Law]] / [[Livius Arnsmann]] on unresolved issue
- [ ] DBD newsletter: confirm "Re-add Triptease Update" button is stable

## Someday/Maybe
- [ ] Bulk generation for [[Guest Personas]] (currently manual)
- [ ] Redesign infographic graphics generation
- [ ] HubSpot Breeze automation exploration
